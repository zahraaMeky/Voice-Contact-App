...
class UserScreen(Screen):
    ...
    def fetch_and_display_data(self):
        ...
        for row in rows:
            ...
            desc_label = Label(text=app.arabicText(room_desc), color=(0.909, 0.667, 0.259, 1),font_size="16sp", font_name='resources/JannaLTBold.ttf')
            card.add_widget(desc_label)
            status_image = Image(source="resources/waveMute.png",size_hint=(None, None), size=(300,110))
            status_image.i=i
    ...
    def callAllfunc(self,instance):
        ...
        if instance.st == 0 :
            ...
            conn = sqlite3.connect('voiceContact.db')
            cursor = conn.cursor()
            cursor.execute('SELECT ip FROM rooms')
...
class UserControlScreen(Screen):
    ...
    def add_user(self,instance):
        app = VoiceContactApp.get_running_app()
        popup_content = boxColor()
        room_name_input = Ar_text(multiline=False,background_color=(69/255, 69/255, 69/255,1),
                        foreground_color=(210 / 255, 141 / 255, 26 / 255, 1),font_size="16sp",font_name='resources/JannaLTBold.ttf' )
        userpassword_input = Ar_text(multiline=False,background_color=(69/255, 69/255, 69/255,1),foreground_color=(210 / 255, 141 / 255, 26 / 255, 1),font_size="16sp", font_name='resources/JannaLTBold.ttf')
...
class AdminScreen(Screen):
    ...
    def fetch_and_display_data(self):
        ...
        for row in rows:
            ...
            card.add_widget(status_image)
            card.add_widget(connect_button)
            btn_layout =  GridLayout(cols=2,spacing=180)
    ...
    def edit_room(self, instance):
        ...
        # def edit_room_button(instance):
            ...
            popup_content = boxColor()
            room_name_input = Ar_text(text=app.arabicText(name),multiline=False,background_color=(69/255, 69/255, 69/255,1),foreground_color=(210 / 255, 141 / 255, 26 / 255, 1),font_size="16sp", font_name='resources/JannaLTBold.ttf')
            room_IP_input = Ar_text(text=app.arabicText(ip),multiline=False,background_color=(69/255, 69/255, 69/255,1),foreground_color=(210 / 255, 141 / 255, 26 / 255, 1),font_size="16sp", font_name='resources/JannaLTBold.ttf')
            room_Dec_input = Ar_text(text=app.arabicText(desc),multiline=False,background_color=(69/255, 69/255, 69/255,1),foreground_color=(210 / 255, 141 / 255, 26 / 255, 1),font_size="16sp", font_name='resources/JannaLTBold.ttf')
    ...
    def add_room(self):
        ...
        # print('room_name_input',room_name_input)

        room_IP_input = Ar_text(multiline=False,background_color=(69/255, 69/255, 69/255,1),foreground_color=(210 / 255, 141 / 255, 26 / 255, 1),font_size="16sp", font_name='resources/JannaLTBold.ttf')
        room_des_inp = Ar_text(multiline=False,background_color=(69/255, 69/255, 69/255,1),foreground_color=(210 / 255, 141 / 255, 26 / 255, 1),font_size="16sp", font_name='resources/JannaLTBold.ttf')
    ...
    def save_new_room(self, name_input, IP_input,Des_input):
        def save_new_room_button(instance):
            ...
            if new_name !="" and new_IP!="" and len(new_IP.split("."))==4 and new_Des!="":
                ...
                self.popup.dismiss()  # Close the popup after saving
                self.fetch_and_display_data()  # Refresh the data after adding a new room
...
class VoiceContactApp(MDApp):
    ...
    def on_start(self):
        ...
        db_connection= sqlite3.connect( self.resources + '/voiceContact.db')
